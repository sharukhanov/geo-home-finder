...
const STEPS = [
  {
    emoji: "📍",
    title: "Отметьте свои места",
    text: "Работа, учёба, зал — куда вы ездите каждую неделю.",
  },
  {
    emoji: "🚇",
    title: "Скажите, как добираетесь",
    text: "На метро, на машине или пешком — и сколько готовы тратить на дорогу.",
  },
  {
    emoji: "🟢",
    title: "Смотрите зелёную зону",
    text: "Это районы, откуда вы успеваете во все свои места. Здесь и ищите жильё.",
  },
];
      ...
      <DialogContent className="max-w-lg p-0 max-h-[90vh] overflow-y-auto">
        <div className="px-6 pt-8 pb-6 text-center">
          ...
          <p className="text-slate-600 mt-2">
            Fatera покажет районы, из которых удобно добираться
